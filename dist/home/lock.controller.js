        ...
        if (data.success) {
            let result = await (0, rxjs_1.firstValueFrom)(this.httpService.get('https://api.ttlock.com/v3/lock/detail?clientId=' + enterpassAppIds_1.EnterPassConfig.clientId + '&accessToken=' + access_token + '&lockId=' + data.lockId + '&date=' + new Date().valueOf())).then(response => {
                ...
                if (response && response.data.lockId) {
                    return this.lockService.create({ lockData: Object.assign({}, response.data), created: new Date().valueOf(), updated: new Date().valueOf(), createdBy: lock.createdBy, lockId: response.data.lockId, lockDataString: lock.lockData }).then((res) => {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_a = typeof get_records_dto_1.GetRecordsDTO !== "undefined" && get_records_dto_1.GetRecordsDTO) === "function" ? _a : Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof delete_lock_dto_1.DeleteLockDTO !== "undefined" && delete_lock_dto_1.DeleteLockDTO) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
